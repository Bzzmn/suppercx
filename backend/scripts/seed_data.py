        ...
        try:
            ...
            ticket_messages = [
                TicketMessage(
                    ...
                    conversation="No puedo acceder a mi cuenta. ¿Pueden ayudarme?",
                ),
                TicketMessage(
                    ticket_id=tickets[0].id,
                    conversation="Por supuesto, vamos a verificar su cuenta. ¿Puede proporcionarme su nombre de usuario?",
                ),
                TicketMessage(
                    ticket_id=tickets[1].id,
                    conversation="Tengo una pregunta sobre mi última factura.",
                ),
                TicketMessage(
                    ticket_id=tickets[1].id,
                    conversation="Claro, estaré encantado de ayudarle con su consulta sobre la factura. ¿Puede proporcionar más detalles?",
                ),
                TicketMessage(
                    ticket_id=tickets[2].id,
                    conversation="Me gustaría sugerir una nueva característica para la aplicación.",
                ),
            ]
